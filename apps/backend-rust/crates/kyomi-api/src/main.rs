...
async fn main() {
    ...
    let mcp_sessions = kyomi_api::mcp_session_manager::MCPSessionManager::new(kv.clone());
    ...
    let router = kyomi_api::build_router(state);
    ...
    let app = kyomi_api::wrap_service(router);
