-- Knowledge files: markdown file tree per workspace
...
-- Knowledge chunks: embedded text chunks for semantic search
...
-- Knowledge file table references: backtick-extracted table names
