...
/**
 * PasskeyRecovery - Request a recovery link for lost passkeys
 *
...
export default function PasskeyRecovery() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await apiClient.post('/api/v1/auth/passkeys/recovery/request', { email });
      setSubmitted(true);
    } catch (err) {
      // Still show success to prevent email enumeration
      // The backend always returns the same message regardless of whether the email exists
      setSubmitted(true);
    } finally {
      setLoading(false);
    }
