...
-- tokens (confirmed against 20260215000000_baseline.sql and every migration
-- since -- `chat_messages.role` is an unrelated chat-message-speaker column,
-- not a workspace role). No production row has ever been able to hold
