...
CREATE TABLE IF NOT EXISTS workspace_integrations (
    ...
    installed_by VARCHAR(50) REFERENCES users(user_id),
...
CREATE TABLE IF NOT EXISTS watch_alert_channels (
    id VARCHAR(50) NOT NULL PRIMARY KEY,
    watch_id VARCHAR(50) NOT NULL REFERENCES watches(watch_id) ON DELETE CASCADE,
...
ALTER TABLE chat_sessions
    ...
    ADD COLUMN IF NOT EXISTS platform_thread_key TEXT;
