                ...
                if editing.get() {
                    view! {
                        <input
                            node_ref=input_ref
                            type="text"
                            class="text-lg font-semibold font-display text-foreground bg-transparent border-b-2 border-primary outline-none w-full"
                    ...
                    view! {
                        <span
                            class="text-lg font-semibold font-display text-foreground truncate cursor-pointer hover:text-primary transition-colors block"
