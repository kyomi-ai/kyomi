...
/// Matches the React `formatDate` function in SaveDashboardModal.jsx:
...
/// Dashboard icon — React: grid/layout SVG path from SaveDashboardModal.jsx line 250
...
/// A single dashboard entry in the existing dashboards list.
/// React: The `dashboards.map((dashboard) => ...)` block (lines 233-268).
#[component]
